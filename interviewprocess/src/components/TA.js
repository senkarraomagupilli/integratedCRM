        ...
        <div className='card-body'>
          <div className='row'>
            <div className='col-12'>
              <button type="button" data-bs-toggle="modal" data-bs-target="#exampleModal" style={{ float: "right" }} className='btn btn-primary'>
                New User
              </button>
            </div>
          </div>
            ...
            <table class="table table-hover table-bordered">
              ...
              <tbody>
                <tr>
                  ...
                  <td>test</td>
                  <td>
                    <button type='button' data-bs-toggle="modal" data-bs-target="#exampleModal" onClick={()=>{setShow(true)}} className='btn btn-success'>
                      Edit
                    </button>
                  </td>
